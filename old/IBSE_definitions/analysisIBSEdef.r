...
#synonymous words
allFilesx <- tm_map(allFilesx, content_transformer(gsub),  pattern = "<U+2013>", replacement = "")
allFilesx <- tm_map(allFilesx, content_transformer(gsub),  pattern = "<U+2019>", replacement = "")
...
allFilesx <- tm_map(allFilesx, content_transformer(gsub),  pattern = "(\\<johndewey\\>|\\<dewey1991p108\\>|\\<dewey1956pp4748\\>|\\<dewey1910\\>|\\<deweys\\>)", replacement = "dewey")
...
allFilesx <- tm_map(allFilesx, content_transformer(gsub),  pattern = "(\\<logically\\>)", replacement = "logical")
...
V(article01)$id<-V(article01)$name
V(article02)$id<-V(article02)$name
V(article03)$id<-V(article03)$name
V(article04)$id<-V(article04)$name
V(article05)$id<-V(article05)$name
V(article06)$id<-V(article06)$name
V(article07)$id<-V(article07)$name
V(article08)$id<-V(article08)$name
V(article09)$id<-V(article09)$name
V(article10)$id<-V(article10)$name
V(article11)$id<-V(article11)$name
V(article12)$id<-V(article12)$name
V(article13)$id<-V(article13)$name
V(article14)$id<-V(article14)$name
V(article15)$id<-V(article15)$name
V(article16)$id<-V(article16)$name
V(article17)$id<-V(article17)$name
V(article18)$id<-V(article18)$name
V(article19)$id<-V(article19)$name
V(article20)$id<-V(article20)$name
V(article21)$id<-V(article21)$name
V(article22)$id<-V(article22)$name
V(article23)$id<-V(article23)$name
V(article24)$id<-V(article24)$name
V(article25)$id<-V(article25)$name
V(article26)$id<-V(article26)$name
V(article27)$id<-V(article27)$name
V(article28)$id<-V(article28)$name
V(article29)$id<-V(article29)$name
V(article30)$id<-V(article30)$name
V(article31)$id<-V(article31)$name
V(article32)$id<-V(article32)$name
V(article33)$id<-V(article33)$name
V(article34)$id<-V(article34)$name
V(article35)$id<-V(article35)$name

allNet<-graph.edgelist(allEdge,directed=T)
E(allNet)$weight<-1
allNet<-simplify(allNet,remove.multiple = T,edge.attr.comb = "sum")
V(allNet)$id<-V(allNet)$name
allNetBB05<-backboneNetwork(allNet,0.05,2)
allNetBB01<-backboneNetwork(allNet,0.01,2)
allNetBB001<-backboneNetwork(allNet,0.001,2)
allNetBB0001<-backboneNetwork(allNet,0.0001,2)

write.graph(allNet,"allNet.graphml",format="graphml")
write.graph(allNet,"allNet.net",format="pajek")
write.graph(allNetBB0001,"allNetBB.net",format="pajek")
write.graph(article01,"article01.net",format="pajek")
write.graph(article02,"article02.net",format="pajek")
write.graph(article03,"article03.net",format="pajek")
write.graph(article04,"article04.net",format="pajek")
write.graph(article05,"article05.net",format="pajek")
write.graph(article06,"article06.net",format="pajek")
write.graph(article07,"article07.net",format="pajek")
write.graph(article08,"article08.net",format="pajek")
write.graph(article09,"article09.net",format="pajek")
write.graph(article10,"article10.net",format="pajek")
write.graph(article11,"article11.net",format="pajek")
write.graph(article12,"article12.net",format="pajek")
write.graph(article13,"article13.net",format="pajek")
write.graph(article14,"article14.net",format="pajek")
write.graph(article15,"article15.net",format="pajek")
write.graph(article16,"article16.net",format="pajek")
write.graph(article17,"article17.net",format="pajek")
write.graph(article18,"article18.net",format="pajek")
write.graph(article20,"article20.net",format="pajek")
write.graph(article21,"article21.net",format="pajek")
write.graph(article22,"article22.net",format="pajek")
write.graph(article23,"article23.net",format="pajek")
write.graph(article24,"article24.net",format="pajek")
write.graph(article25,"article25.net",format="pajek")
write.graph(article26,"article26.net",format="pajek")
write.graph(article27,"article27.net",format="pajek")
write.graph(article28,"article28.net",format="pajek")
write.graph(article29,"article29.net",format="pajek")
write.graph(article30,"article30.net",format="pajek")
write.graph(article31,"article31.net",format="pajek")
write.graph(article32,"article32.net",format="pajek")
write.graph(article33,"article33.net",format="pajek")
write.graph(article34,"article34.net",format="pajek")
write.graph(article35,"article35.net",format="pajek")
...
write.graph(net1gram,"net1gram.net",format="pajek")
write.graph(net2gram,"net2gram.net",format="pajek")
write.graph(net1gramBB,"net1gramBB.net",format="pajek")
write.graph(net2gramBB,"net2gramBB.net",format="pajek")
write.graph(net3gram,"net3gram.net",format="pajek")
write.graph(net3gramBB,"net3gramBB.net",format="pajek")
write.graph(net4gram,"net4gram.net",format="pajek")
write.graph(net5gram,"net5gram.net",format="pajek")
write.graph(net6gram,"net6gram.net",format="pajek")
write.graph(net7gram,"net7gram.net",format="pajek")
write.graph(net8gram,"net8gram.net",format="pajek")
